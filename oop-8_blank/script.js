...
const divOne = document.querySelector('.div-2-1')
const divTwo = document.querySelector('.div-2-2')
f2.call(divOne);
f2.call(divTwo)
...
const divThree = document.querySelector('.div-3-1')
const divFour = document.querySelector('.div-3-2')
f3.call(divThree, 'red');
f3.call(divFour, 'orange')
...
const divFive = document.querySelector('.div-4-1')
const divSix = document.querySelector('.div-4-2')
f4.apply(divFive, ['red']);
f4.apply(divSix, ['orange'])
...
const divSeven = document.querySelector('.div-5-1')
const divEight = document.querySelector('.div-5-2')
f5.apply(divSeven)
f5.apply(divEight)
...
let bindF71 = f7.bind(document.querySelector('.div-7-1'))
let bindF72 = f7.bind(document.querySelector('.div-7-2'))
